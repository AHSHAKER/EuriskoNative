...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'The Xiaomi 13 Ultra is a photography powerhouse equipped with Leica-branded cameras and advanced imaging software. Its curved display, high refresh rate, and fast charging capabilities make it a top-tier device for media consumption and mobile photography.',
    price: 1000,
    images: [
      {
